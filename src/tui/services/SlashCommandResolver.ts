import { CommandKind, SlashCommand, CommandConflict } from '../ui/contexts/UIStateContext.js';
...
export class SlashCommandResolver {
   ...
   */
  private static handleConflict(incoming: SlashCommand, registry: CommandRegistry): string {
  ...
  private static getRenamedName(
    ...
    const isExtensionPrefix = kind === CommandKind.SKILL || kind === CommandKind.EXTENSION_FILE;
