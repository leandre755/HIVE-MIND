...
export class TerminalCapabilityManager {
  ...
  private static readonly KITTY_REGEX = /\[\?(\d+)u/;
  // Terminal Name/Version response: DCS > | text ST (or BEL)
  private static readonly TERMINAL_NAME_REGEX = /P>\|([^;\r\n]+)/;
  // Primary Device Attributes: CSI ? ID ; ... c
  private static readonly DEVICE_ATTRIBUTES_REGEX = /\[\?[\d;]+c/;
  ...
  private static readonly MODIFY_OTHER_KEYS_REGEX = /\[>4;(\d+)m/;
