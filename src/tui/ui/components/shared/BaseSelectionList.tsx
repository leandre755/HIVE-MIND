...
interface SelectionListItemRowProps<T, TItem extends SelectionListItem<T> = SelectionListItem<T>> {
  item: TItem;
  itemIndex: number;
  isSelected: boolean;
  isFocused: boolean;
...
function SelectionListItemRow<T, TItem extends SelectionListItem<T> = SelectionListItem<T>>({
  item,
  itemIndex,
  isSelected,
  isFocused,
