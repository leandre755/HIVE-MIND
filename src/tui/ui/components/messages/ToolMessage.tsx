...
export const ToolMessage: React.FC<ToolMessageProps> = ({
  ...
  return (
    ...
    <>
      ...
      >
        <ToolStatusIndicator status={status} name={name} isFocused={isThisShellFocused} />
        <ToolInfo
          name={name}
          status={status}
        ...
        />
        <FocusHint shouldShowFocusHint={shouldShowFocusHint} shellFocused={isThisShellFocused} />
