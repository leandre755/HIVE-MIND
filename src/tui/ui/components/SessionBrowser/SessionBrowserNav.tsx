 ...
 */
export const SearchModeDisplay = ({ state }: { state: SessionBrowserState }): React.JSX.Element => (
  <Box marginTop={1}>
 ...
 */
export const NoResultsDisplay = ({ state }: { state: SessionBrowserState }): React.JSX.Element => (
  <Box marginTop={1}>
