import { cleanMessage, type SessionInfo, type TextMatch } from '../../../utils/sessionUtils.js';
...
export const findTextMatches = (
  ...
  for (const message of messages) {
    ...
    let matchIndex = lowerContent.indexOf(lowerQuery, 0);
    while (matchIndex !== -1) {
      ...
      matchIndex = lowerContent.indexOf(lowerQuery, startIndex);
    }
  }
 ...
 */
export const filterSessions = (sessions: SessionInfo[], query: string): SessionInfo[] => {
  if (!query.trim()) {
