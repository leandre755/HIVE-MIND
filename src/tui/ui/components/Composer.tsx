...
export const Composer = ({ isFocused = true }: { isFocused?: boolean }) => {
  ...
  const { hasPendingActionRequired, shouldCollapseDuringApproval } = useComposerStatus();

  const isPassiveShortcutsHelpState =
    uiState.isInputActive && uiState.streamingState === 'idle' && !hasPendingActionRequired;
  ...
  const showShortcutsHelp =
    uiState.shortcutsHelpVisible && uiState.streamingState === 'idle' && !hasPendingActionRequired;
  ...
  let composerPlaceholder = '  Type your message or @path/to/file';
  if (vimEnabled) {
    if (vimMode === 'INSERT') {
      composerPlaceholder = "  Press 'Esc' for NORMAL mode.";
    } else {
      composerPlaceholder = "  Press 'i' for INSERT mode.";
    }
  } else if (inputState.shellModeActive) {
    composerPlaceholder = '  Type your shell command';
  }
